                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-free-checkout" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane  active" id="tab-api">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="weepay_payment_checkout_type"><?php echo $entry_form_checkout_type; ?></label>
                                <div class="col-sm-10">
                                    <select name="weepay_payment_checkout_type" class="form-control">
                                        <?php if ($weepay_payment_checkout_type == "onepage") { ?>
                                            <option value="normal"><?php echo $entry_class_normal ?></option>
                                            <option value="onepage" selected="selected"><?php echo $entry_class_onepage; ?></option>
                                        <?php } else { ?>
                                            <option value="normal" selected="selected"><?php echo $entry_class_normal ?></option>
                                            <option value="onepage"><?php echo $entry_class_onepage; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
