...
class ControllerPaymentWeepayPayment extends Controller {
    ...
    public function index() {
        ...
        $data['entry_form_checkout_type'] = $this->language->get('entry_form_checkout_type');
        ...
        if (isset($this->request->get['update_error'])) {
            ...
            if (!empty($versionCheck['version_status']) AND $versionCheck['version_status'] == '1') {
                ...
                $data['version_update_link'] = $this->url->link('payment/weepay_payment/update', 'token=' . $this->session->data['token'] . "&version=$version_updatable", true);
            }
        }
        ...
        $data['action'] = $this->url->link('payment/weepay_payment', 'token=' . $this->session->data['token'], 'SSL');
    ...
    public function order() {
        ...
        return $this->load->view('payment/weepay_order.tpl', $data);
    }
